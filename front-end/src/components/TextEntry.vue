...
<template>
    <div>
        <label v-show="label.length != 0" :for="id"
            class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-100">{{ label }}</label>
        <input :value="value" :id="id" :type="type" :required="required" :disabled="disabled"
