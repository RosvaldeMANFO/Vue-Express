...
<template>
    <div>
        <div class="w-full fixed top-0 z-20 shadow-md p-3 dark:bg-gray-700 bg-gray-500">
        ...
        <div class="mt-12 fixed h-screen inset-y-0 left-0 w-64 dark:bg-gray-700 bg-gray-500 p-4 transition-transform transform"
